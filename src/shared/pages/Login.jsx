...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // This is a mock login - in a real app, you would call your API here
      ...
      if (email === 'admin@hrportal.com' && password === 'admin123') {
        user = {
          id: '1',
          name: 'Admin sid',
      ...
      } else if (email === 'employee@hrportal.com' && password === 'employee123') {
        user = {
          id: '2',
          name: 'sid',
...
// Redirect to role-based public layout
if (user.role === 'admin') {
  navigate('/admin/home');
} else {
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3">
              <div className="bg-gray-50 p-3 rounded-md">
                ...
                <p className="text-xs text-gray-500">Email: admin@hrportal.com</p>
                <p className="text-xs text-gray-500">Password: admin123</p>
              </div>
              <div className="bg-gray-50 p-3 rounded-md">
                <p className="text-sm font-medium text-gray-900">Employee</p>
                <p className="text-xs text-gray-500">Email: employee@hrportal.com</p>
