...
const PasswordUpdateModal = ({ isOpen, onClose, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${process.env.REACT_APP_URL}/api/auth/update-password`, 
        passwordData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
                ...
                <div className="bg-[#1e1e1e] rounded-xl border border-[#2a2a2a] p-6 hover-lift backdrop-blur-lg">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-sm font-light text-[#a3a3a3] mb-2">Country of birth</label>
                        {editMode ? (
                          <input
                            type="text"
                      ...
                      <div>
                        <label className="block text-sm font-light text-[#a3a3a3] mb-2">Citizenship Status</label>
                        {editMode ? (
                          <select
                      ...
                      <div>
                        <label className="block text-sm font-light text-[#a3a3a3] mb-2">Emergency Contact Name</label>
                        {editMode ? (
                          <input
                            type="text"
                      ...
                      <div>
                        <label className="block text-sm font-light text-[#a3a3a3] mb-2">Emergency Contact Number</label>
                        {editMode ? (
                          <input
                            type="text"
