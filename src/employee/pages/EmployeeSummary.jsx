  ...
  const fetchAllEmployeeData = async () => {
    try {
      ...
      const [employeeResponse, personalResponse, jobResponse] = await Promise.allSettled([
        fetch(`${API_BASE_URL}/employees/employee`),
        fetch(`${API_BASE_URL}/personalDetails/individual`),
        fetch(`${API_BASE_URL}/jobDetails/employee`)
      ]);
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: "Job Profile", value: jobData?.job_profile || employeeData?.job_profile_progression_model_designation || 'N/A' },
              ...
              <div 
                ...
                style={{
                  background: '#1e1e1e',
                  backdropFilter: 'blur(10px)',
                  boxShadow: '0 4pack 6px -1px rgba(0, 0, 0, 0.8)'
                }}
              >
                <h3 className="text-white font-normal mb-4 flex items-center" style={{ fontSize: '16px' }}>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {jobData?.skills ? (
                    ...
                    // Fallback skills if no data from backend
