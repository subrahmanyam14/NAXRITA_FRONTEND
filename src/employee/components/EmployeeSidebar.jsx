...
const EmployeeSidebar = ({ sidebarOpen = true, setSidebarOpen = () => {} }) => {
  ...
  const [activeItem, setActiveItem] = useState('/employee/compensation'); // Default active item

  // Mock user data (replace with your localStorage logic)
        ...
        <div className="flex-1 flex flex-col h-screen">
              ...
              {navigation.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full group flex items-center px-3 py-2.5 text-sm font-normal rounded-md transition-colors duration-150 ${
                      isActive
          ...
          <div className="flex-shrink-0 p-4 bg-gray-950 border-t border-gray-700">
            <div className="flex items-center">
              <div className="inline-flex h-9 w-9 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 items-center justify-center text-sm font-medium text-white shadow-lg">
