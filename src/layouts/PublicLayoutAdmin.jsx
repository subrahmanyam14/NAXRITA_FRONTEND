...
const PublicAdminLayout = () => {
  ...
  <div className="relative flex items-center justify-between gap-4">
    <div className="max-w-2xl">
              ...
              <h2 className="text-4xl font-bold bg-gradient-to-r from-white via-[#2563eb] to-white bg-clip-text text-transparent mb-4 font-jakarta ">Admin Portal</h2>
          <p className=" bg-gradient-to-r from-[#ffffff] via-[#2563eb] to-white bg-clip-text text-transparent mb-6 font-jakarta">
